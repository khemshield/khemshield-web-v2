...
export const courses: Course[] = [
  ...
  // ──────────────────────────── AI ────────────────────────────────
  {
    ...
    overview:
      "Go beyond demos. Where our Agentic AI course is about building autonomous agents, this program is about the models themselves: how they work, how to train and adapt them, and how to run them reliably in production. You will study transformer architectures, train and fine-tune models with the modern ML stack, ground them in your own data, then evaluate, serve, and monitor them with proper MLOps. Every phase is project-driven and builds toward a deployed, monitored capstone.",
    audience:
    ...
    outcomes: [
      ...
      "Train, fine-tune, and adapt models with PyTorch, TensorFlow, and Hugging Face",
      "Evaluate, benchmark, and optimise models for quality and cost",
      "Integrate LLM APIs from Anthropic, OpenAI, and Google into applications",
      "Ground models in your own data with embeddings and retrieval",
      "Apply MLOps to version, serve, monitor, and retrain models",
      "Deploy AI features reliably to the cloud",
      "Build AI responsibly with safety, guardrails, and evaluation",
    ],
    tools: [
      "Python",
      "PyTorch",
    ...
    curriculum: [
      ...
      {
        title: "Deep Learning and Transformer Architectures",
        subtitle: "Understand the models from the inside out",
        topics: [
          "Neural network and deep learning fundamentals",
          "Training basics: loss, gradients, and optimisation",
          "The transformer architecture and the attention mechanism",
          "Tokenisation, context windows, and model capabilities",
          "Embeddings and vector representations of meaning",
      ...
      },
      {
        ...
        subtitle: "Adapt models to your own problem, the core ML-engineer skill",
        topics: [
          "The ML workflow: data, training, evaluation, iteration",
          "PyTorch and TensorFlow for engineers",
          "Datasets, tokenisers, and training loops",
          "Fine-tuning and parameter-efficient methods (LoRA, PEFT)",
          "Transfer learning across text, vision, and tabular data",
          "Deciding when to prompt, retrieve, fine-tune, or train from scratch",
        ],
        tools: ["PyTorch", "TensorFlow", "Hugging Face", "scikit-learn"],
      },
      {
        title: "Model Evaluation and Optimisation",
        subtitle: "Prove quality and make models efficient",
        topics: [
          "Designing evaluations: benchmarks, offline evals, and metrics",
          "Regression testing and tracking experiments",
          "Quantisation, distillation, and model compression",
          "Inference optimisation: latency, throughput, and cost",
          "Hardware, batching, and serving efficiency",
        ],
        tools: ["Weights & Biases", "MLflow"],
      },
      {
        title: "Working with Pretrained Models and LLM APIs",
        subtitle: "Run frontier models and ground them in your data",
        topics: [
          "Integrating LLM APIs: Anthropic Claude, OpenAI, and Google",
          "Essential prompting and structured, schema-validated outputs",
          "Embeddings and semantic search to ground models",
          "Retrieval-augmented generation (RAG) over your own data",
          "Streaming, batching, token budgeting, and cost control",
        ],
        tools: [
          "Claude (Anthropic)",
          "OpenAI",
      ...
      },
      {
        ...
        subtitle: "Run models reliably across their lifecycle",
        topics: [
          "Serving models behind APIs with FastAPI and as batch jobs",
          "Model and data versioning, and model registries",
          "CI/CD for ML and reproducible pipelines",
      ...
      {
        title: "Safety, Responsible AI, and Capstone",
        subtitle: "Ship models that are safe, evaluated, and stakeholder-ready",
        topics: [
          "AI safety, alignment, and ethical considerations",
          "Guardrails, prompt-injection defence, and privacy",
          "Communicating model behaviour and trade-offs to stakeholders",
          "Capstone: train or fine-tune, then deploy and monitor a model in production",
        ],
